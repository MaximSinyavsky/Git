...
Файл .gitignore используется для указания файлов и каталогов, которые не должны быть отслеживаемыми Git. Этот файл обеспечивает удобный способ игнорирования временных, локальных или сгенерированных файлов, предотвращая их случайное добавление в репозиторий.

* Откройте файл .gitignore в текстовом редакторе и добавьте правила игнорирования:
      ...
      *.tmp
      ...
      .config
      # Игнорировать директорию с зависимостями
      /node_modules/

      # Игнорировать все файлы внутри директории
      /assets/*
* Сохраните и закройте файл.
* Добавьте и зафиксируйте файл .gitignore в репозитории:
...
### Удаление через GitHub - возмонжно полностью удалить, используя пользовательский интерфейс.
...
Команда git reset может использоваться для отмены изменений в индексе, а также для изменения HEAD.
